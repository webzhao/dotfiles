...
syntax keyword javaScriptIdentifier     arguments this let const var void yield await
...
syntax keyword javaScriptReserved       abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws goto private transient debugger implements protected volatile double import public async
...
runtime syntax/es6-modules/*.vim
